...
<svg
  ...
  {:else if name === "blog"}
    <path d="M3 6H2V13H3V6Z" />
    <path d="M14 2H13V13H14V2Z" />
    <path d="M5 2H4V14H5V2Z" />
    <path d="M5 6H3V7H5V6Z" />
    <path d="M13 13H3V14H13V13Z" />
    <path d="M13 2H5V3H13V2Z" />
    <path d="M12 4H6V6H12V4Z" />
    <path d="M12 7H6V8H12V7Z" />
    <path d="M12 9H6V10H12V9Z" />
    <path d="M12 11H6V12H12V11Z" />
  {:else if name === "bluesky"}
    <path
      d="M4.60116 3.42837C5.97693 4.46121 7.45673 6.55538 8.00003 7.67924C8.54338 6.55547 10.0231 4.46119 11.3989 3.42837C12.3916 2.68311 14 2.10647 14 3.94136C14 4.30782 13.7899 7.01976 13.6667 7.46003C13.2383 8.99073 11.6775 9.38114 10.2891 9.14484C12.716 9.55789 13.3334 10.926 12.0001 12.2942C9.46787 14.8926 8.36057 11.6423 8.07671 10.8094C8.0247 10.6567 8.00036 10.5853 8 10.646C7.99964 10.5853 7.9753 10.6567 7.92329 10.8094C7.63955 11.6423 6.53227 14.8927 3.99993 12.2942C2.66662 10.926 3.28397 9.55781 5.7109 9.14484C4.32246 9.38114 2.7616 8.99073 2.33333 7.46003C2.2101 7.01972 2 4.30778 2 3.94136C2 2.10647 3.60845 2.68311 4.60109 3.42837H4.60116Z" />
  {:else if name === "branch"}
  ...
  {:else if name === "clone"}
    <path d="M4 8L4 7L6 7V8H4Z" />
    <path d="M10 8V7H12V8H10Z" />
    <path d="M5 9V8H6L6 9H5Z" />
    <path d="M6 10V9H7V10H6Z" />
    <path d="M7 11V10H9V11H7Z" />
    <path d="M10 9L10 8L11 8V9H10Z" />
    <path d="M9 10L9 9H10L10 10H9Z" />
    <path d="M6 2H7L7 7H6L6 2Z" />
    <path d="M9 2H10V7H9V2Z" />
    <path d="M2 13L14 13V14L2 14V13Z" />
    <path d="M2 11H3L3 13H2L2 11Z" />
    <path d="M13 11H14L14 13H13V11Z" />
  ...
  {:else if name === "windows"}
    <path d="M2 2H7V7H2V2Z" />
    <path d="M9 2H14V7H9V2Z" />
    <path d="M2 9H7V14H2V9Z" />
    <path d="M9 9H14V14H9V9Z" />
  {:else if name === "zulip"}
    <path
      d="M14.2775 3.79429C14.2775 4.39877 14.006 4.93586 13.5923 5.26168L9.57586 8.84866C9.50126 8.9126 9.40429 8.80949 9.4581 8.72344L10.9314 5.77373C10.9727 5.69114 10.9191 5.58964 10.8344 5.58964H5.12012C4.23509 5.58964 3.51099 4.78188 3.51099 3.79482C3.51099 2.8075 4.23509 2 5.12012 2H12.6684C13.5534 1.99947 14.2775 2.80723 14.2775 3.79429ZM5.12012 14H12.6684C13.5534 14 14.2775 13.1922 14.2775 12.2052C14.2775 11.2179 13.5534 10.4104 12.6684 10.4104H6.9541C6.86938 10.4104 6.81583 10.3089 6.85712 10.2263L8.33038 7.27656C8.3842 7.19051 8.28722 7.08741 8.21263 7.15134L4.1962 10.7378C3.78246 11.0633 3.51099 11.6007 3.51099 12.2052C3.51099 13.1922 4.23509 14 5.12012 14Z" />
  {/if}
</svg>
