<script lang="ts">
  let features = [
    ...
    },
    {
      ...
      description:
        "Contribute to the network's evolution through transparent community-driven governance.<br/>No corporate roadmaps — the future is shaped by those who use it.",
      icon: "🌐",
    },
  ] as const;
</script>
