import "clsx";
import { N as ensure_array_like, M as escape_html, z as push, O as fallback, E as attr, P as bind_props, B as pop, C as attr_class, F as attr_style, J as slot, Q as copy_payload, R as assign_payload } from "../../chunks/index.js";
...
function Command($$payload, $$props) {
  ...
  $$payload.out += `<div${attr_class("wrapper svelte-1is5wpf", void 0, { "full-width": fullWidth })}><div${attr_style("", { display: "flex" })}>`;
  if (!flatLeft) {
    $$payload.out += "<!--[-->";
  ...
  $$payload.out += `<!--]--> <div class="cmd-horizontal svelte-1is5wpf"></div> <div${attr_style("", { width: "2px", height: "2px" })}></div></div> <div class="cmd-center svelte-1is5wpf"><div class="cmd-vertical svelte-1is5wpf"></div> <div role="button" tabindex="0"${attr_class("cmd txt-overflow svelte-1is5wpf", void 0, { "full-width": fullWidth })}>$ ${escape_html(command)} <div class="clipboard svelte-1is5wpf">`;
  Clipboard($$payload, { text: command });
  $$payload.out += `<!----></div></div> <div class="cmd-vertical svelte-1is5wpf"></div></div> <div${attr_style("", { display: "flex" })}>`;
  if (!flatLeft) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div${attr_style("", { width: "2px", height: "2px" })}></div>`;
  } else {
  ...
  $$payload.out += `<!--]--> <div class="cmd-horizontal svelte-1is5wpf"></div> <div${attr_style("", { width: "2px", height: "2px" })}></div></div></div>`;
}
...
function Download($$payload, $$props) {
  ...
  $$payload.out += `<!--]--></div> <span class="or-source-code svelte-1m7idnw">Or check out the <a target="_blank" href="https://app.radicle.xyz/nodes/seed.radicle.xyz/rad:z4D5UCArafTzTQpDZNQRuqswh3ury" class="svelte-1m7idnw">source code.</a></span></div>`;
  pop();
}
